...
public class AchievementsSubCommand implements SubCommand {
    ...
    @Override
    public String getName() { return "achievements"; }

    @Override
    public java.util.List<String> getAliases() { return java.util.List.of("ach", "achs"); }

    @Override
    public String getPermission() { return "dplayerprofiles.use"; }

    @Override
    public MessageKey getDescriptionKey() { return MessageKey.CMD_DESC_ACHIEVEMENTS; }
